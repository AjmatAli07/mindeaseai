...
class _PomodoroScreenState extends State<PomodoroScreen> {
  ...
  void _showMoodDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content:
            const Text("Checking in helps you understand your stress level."),
        actions: [
          TextButton(
            onPressed: () => _onMoodSelected("calm"),
            child: const Text("😌 Calm"),
          ),
          TextButton(
            onPressed: () => _onMoodSelected("okay"),
            child: const Text("🙂 Okay"),
          ),
          TextButton(
            onPressed: () => _onMoodSelected("stressed"),
  ...
  void _onMoodSelected(String mood) {
    ...
    // 🔮 FUTURE USE (optional & free):
    // - save to emotional memory
    // - show suggestions
    // - adjust AI tone
    debugPrint("User mood after pomodoro: $mood");
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                    onPressed: pauseTimer, child: const Text("Pause")),
                OutlinedButton(
                    onPressed: resetTimer, child: const Text("Reset")),
              ],
            ),
          ],
        ),
